// ISO 3166-1 country data: numeric code (used by world-atlas TopoJSON) → alpha2 + alpha3 + name
// Flag emoji is derived from alpha2 code
...
// Complete list of countries with numeric, alpha-2, alpha-3 codes
export const COUNTRIES: CountryInfo[] = [
  ...
  { numeric: "090", alpha2: "XK", alpha3: "XKX", name: "Kosovo" },
];

// Lookup maps for quick access
export const COUNTRIES_BY_NUMERIC = new Map(COUNTRIES.map((c) => [c.numeric, c]));
